...
if __name__ == "__main__":
    ...
    output_capacitor_default_v = output.output_numeric()
    ...
    output_capacitor_1 = output.output_string()
    output_capacitor_2 = output.output_numeric()
    output_capacitor_3 = output.output_string()
    output_capacitor_4 = output.output_numeric()
    output_capacitor_5 = output.output_string()
    output_capacitor_6 = output.output_numeric()
    output_capacitor_7 = output.output_numeric()
    output_capacitor_8 = output.output_numeric()
    ...
    context.setContextProperty("output_capacitor_default_v", output_capacitor_default_v)
    ...
    context.setContextProperty("output_capacitor_5", output_capacitor_5)
    context.setContextProperty("output_capacitor_6", output_capacitor_6)
    context.setContextProperty("output_capacitor_7", output_capacitor_7)
    context.setContextProperty("output_capacitor_8", output_capacitor_8)
    ...
    main_logic_input = {
        ...
        "output_capacitor": {
            ...
            "5": output_capacitor_5,
            "6": output_capacitor_6,
            "7": output_capacitor_7,
            "8": output_capacitor_8
        },
